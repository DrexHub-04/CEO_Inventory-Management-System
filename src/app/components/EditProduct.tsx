...
import { getProduct, updateProduct, getCategories } from "../utils/storage";
...
export default function EditProduct() {
      ...
      getProduct(id).then((product) => {
        if (product) {
          setFormData({
            ...
            accountablePerson: product.accountablePerson ?? "",
            serviceable: product.serviceable ?? "",
            assignedPerson: product.assignedPerson,
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        <h1 className="font-semibold mb-2">Edit Product</h1>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 max-w-2xl">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block mb-2 font-medium text-gray-700">Notes (date, names, remarks, parts needed ) </label>
            <textarea
              name="notes"
